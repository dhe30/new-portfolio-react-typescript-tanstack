...
<svg style={{position: "absolute"}}>
  <defs>
    <filter id="chromatic-aberration" x="-50%" y="-50%" width="200%" height="200%">
      {/* <!-- Red channel --> */}
      <feOffset in="SourceAlpha" dx="-5" dy="0" result="rShift"/>
      <feFlood flood-color="red" result="redColor"/>
      <feComposite in="redColor" in2="rShift" operator="in" result="redOnly"/>

      {/* <!-- Green channel --> */}
      <feOffset in="SourceAlpha" dx="0" dy="2" result="gShift"/>
      <feFlood flood-color="lime" result="greenColor"/>
      <feComposite in="greenColor" in2="gShift" operator="in" result="greenOnly"/>

      {/* <!-- Blue channel --> */}
      <feOffset in="SourceAlpha" dx="3" dy="0" result="bShift"/>
      <feFlood flood-color="blue" result="blueColor"/>
      <feComposite in="blueColor" in2="bShift" operator="in" result="blueOnly"/>
